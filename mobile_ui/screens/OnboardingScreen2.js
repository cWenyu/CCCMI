...
const OnboardingScreen2 = ({navigation}) => {
  return (
    <Onboarding
    onDone={() => navigation.navigate('SurveyPage')}
    onSkip={() => navigation.navigate('SurveyPage')}
  pages={[
    {
      backgroundColor: '#fff',
      image: <Image source={require('../assets/takesurvey.gif')} style={{height:250, width: 250}}/>,
      title: 'Step 1',
    ...
    },
    {
      ...
      image: <Image source={require('../assets/connectarduino.gif')} style={{height: 300, width: '100%', marginTop: 0}}/>,
      title: 'Step 3',
